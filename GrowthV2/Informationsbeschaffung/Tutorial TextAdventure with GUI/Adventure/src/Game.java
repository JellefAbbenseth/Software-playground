...
public class Game
{
    ...
    JPanel titleNamePanel, startButtonPanel, mainTextPanel, choiceBottomPanel, playerPanel;
    ...
    TitleSceneHandler tsHandler = new TitleSceneHandler();
    ...
    public Game()
    {
        ...
        startButton.setFocusPainted(false); //Let's the focus disappear
    ...
    public void createGameScreen()
    {
        ...
        mainTextArea = new JTextArea("This ist the main text area. This game is going to be great. I'm sure of it!");
        mainTextArea.setBounds(100, 100, 600, 250);
        mainTextArea.setBackground(Color.black);
        mainTextArea.setForeground(Color.white);
        mainTextArea.setFont(normalFont);
        mainTextArea.setLineWrap(true); //If the Text is too long, it will be lacked automatically
        ...
        choice1.setActionCommand("c1"); //Key to let the program recognise the different buttons
        ...
        hpLabelNumber = new JLabel("100"); //the text is just for test reasons
        ...
        weaponLabelName = new JLabel("TestKnife"); //the text is just for test reasons
    ...
    public class TitleSceneHandler implements ActionListener
    {
    ...
    public class ChoiceHandler implements ActionListener
    {
        public void actionPerformed(ActionEvent event)
        {
            String yourChoice = event.getActionCommand(); //Take the recognition code from the buttons

            /*
            if(yourChoice.equals("c1"))  //For just one or two choices its ok, but a switch is better here
            {
                talkGuard();
            }*/
            switch(position) {
